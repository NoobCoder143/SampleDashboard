...
const SampleDashboard = () => {
  ...
  const barChart = "https://quickchart.io/chart?c=%7Btype%3A%27bar%27%2Cdata%3A%7Blabels%3A%5B2012%2C2013%2C2014%2C2015%2C2016%5D%2Cdatasets%3A%5B%7Blabel%3A%27Users%27%2Cdata%3A%5B120%2C60%2C50%2C180%2C120%5D%7D%5D%7D%7D";
  const pieChartData = {
    type: "pie",
    data: {
      labels: ["Tech", "Management", "Sales", "Marketing"],
      datasets: [
        {
          label: "Users by Field",
          data: [50, 30, 20, 10], // Proportion of users in different fields
        },
      ],
    },
  ...
  const pieChart = `https://quickchart.io/chart?c=${JSON.stringify(pieChartData)}`
  ...
  return (
    <>
      ...
      >
        ...
        {/* Pie Chart */}
        <div className="pieChart" style={{ textAlign: "center" ,marginLeft:"20px"}}>
          <h2>Users By Field</h2>
          <img
            src={pieChart}
  ...
  >
    ...
    >
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <a className="nav-link  " href="/sampledashboard">   {/* this one to change*/}
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg
                width="12px"
                height="12px"
            ...
            <span className="nav-link-text ms-1">SampleDashboard</span>
          </a>
        </li>
        <li className="nav-item">
